...
void
test_string_create_with_empty_source ()
{
  const char* source = "";
  string result = string_create (source);
  CU_ASSERT_EQUAL (strlen (result.s), result.len);
...
void
test_string_create_with_null_source ()
{
...
void
test_string_cat_form_empty_sources ()
{
  string s1 = string_create ("");
  string s2 = string_create ("");
  string result = string_cat (s1, s2);
...
void
test_string_cpy_from_empty_source ()
{
...
void
test_string_from_unsigned_long ()
{
  unsigned long n = 100;
