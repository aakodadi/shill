...
TESTOBJECTFILES= \
	...
	${TESTDIR}/tests/post_collection_model_test.o \
...
${OBJECTDIR}/command/command.o: command/command.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/command/command.o command/command.c

${OBJECTDIR}/configuration/configuration.o: configuration/configuration.c 
	${MKDIR} -p ${OBJECTDIR}/configuration
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/configuration/configuration.o configuration/configuration.c

${OBJECTDIR}/error/error.o: error/error.c 
	${MKDIR} -p ${OBJECTDIR}/error
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/error/error.o error/error.c
...
${OBJECTDIR}/model/post.o: model/post.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/post.o model/post.c

${OBJECTDIR}/model/post_collection.o: model/post_collection.c 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/post_collection.o model/post_collection.c

${OBJECTDIR}/model/user.o: model/user.c 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/user.o model/user.c

${OBJECTDIR}/service/repository.o: service/repository.c 
	${MKDIR} -p ${OBJECTDIR}/service
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service/repository.o service/repository.c

${OBJECTDIR}/service/service.o: service/service.c 
	${MKDIR} -p ${OBJECTDIR}/service
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service/service.o service/service.c

${OBJECTDIR}/type/string.o: type/string.c 
	${MKDIR} -p ${OBJECTDIR}/type
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/type/string.o type/string.c
...
${TESTDIR}/TestFiles/f6: ${TESTDIR}/tests/post_collection_model_test.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/tests/configuration_cunit_test.o: tests/configuration_cunit_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/configuration_cunit_test.o tests/configuration_cunit_test.c


${TESTDIR}/tests/post_collection_model_test.o: tests/post_collection_model_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/post_collection_model_test.o tests/post_collection_model_test.c


${TESTDIR}/tests/post_model_cunit_test.o: tests/post_model_cunit_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/post_model_cunit_test.o tests/post_model_cunit_test.c


${TESTDIR}/tests/repository_cunit_test.o: tests/repository_cunit_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/repository_cunit_test.o tests/repository_cunit_test.c


${TESTDIR}/tests/string_type_cunit_test.o: tests/string_type_cunit_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_type_cunit_test.o tests/string_type_cunit_test.c


${TESTDIR}/tests/user_model_cunit_test.o: tests/user_model_cunit_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/user_model_cunit_test.o tests/user_model_cunit_test.c
...
${OBJECTDIR}/argument/argument_nomain.o: ${OBJECTDIR}/argument/argument.o argument/argument.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/argument/argument_nomain.o argument/argument.c;\
	else  \
...
${OBJECTDIR}/command/command_nomain.o: ${OBJECTDIR}/command/command.o command/command.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/command/command_nomain.o command/command.c;\
	else  \
...
${OBJECTDIR}/configuration/configuration_nomain.o: ${OBJECTDIR}/configuration/configuration.o configuration/configuration.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/configuration/configuration_nomain.o configuration/configuration.c;\
	else  \
...
${OBJECTDIR}/error/error_nomain.o: ${OBJECTDIR}/error/error.o error/error.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/error/error_nomain.o error/error.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
...
${OBJECTDIR}/model/post_nomain.o: ${OBJECTDIR}/model/post.o model/post.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/post_nomain.o model/post.c;\
	else  \
...
${OBJECTDIR}/model/post_collection_nomain.o: ${OBJECTDIR}/model/post_collection.o model/post_collection.c 
	${MKDIR} -p ${OBJECTDIR}/model
	@NMOUTPUT=`${NM} ${OBJECTDIR}/model/post_collection.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/post_collection_nomain.o model/post_collection.c;\
	else  \
...
${OBJECTDIR}/model/user_nomain.o: ${OBJECTDIR}/model/user.o model/user.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/user_nomain.o model/user.c;\
	else  \
...
${OBJECTDIR}/service/repository_nomain.o: ${OBJECTDIR}/service/repository.o service/repository.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service/repository_nomain.o service/repository.c;\
	else  \
...
${OBJECTDIR}/service/service_nomain.o: ${OBJECTDIR}/service/service.o service/service.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service/service_nomain.o service/service.c;\
	else  \
...
${OBJECTDIR}/type/string_nomain.o: ${OBJECTDIR}/type/string.o type/string.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/type/string_nomain.o type/string.c;\
	else  \
