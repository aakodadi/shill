...
${TESTDIR}/tests/post_collection_model_test.o: tests/post_collection_model_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/post_collection_model_test.o tests/post_collection_model_test.c
...
${OBJECTDIR}/model/post_collection_nomain.o: ${OBJECTDIR}/model/post_collection.o model/post_collection.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Werror `pkg-config --cflags libcurl` `pkg-config --cflags jansson` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/post_collection_nomain.o model/post_collection.c;\
	else  \
